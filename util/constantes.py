...
SOFT_SKILLS = [
    ...
    [
        ["Comunicacion", "escuchar", "escucha activa", "comprension", "compenetración", "entendimiento", "hablar en publico", "audiencia", "presentacion", "cuestionar",
    ...
    [
        ["Resolucion de conflictos", "final pacifico de conflictos", "conflicto", "conflictos", "mediacion", "mediar", "arbitrar", "arbitraje", "diplomacia", "diplomatico", "disputa", "disputas", "disputar", "gestion de conflictos", "gestion de perspectivas", "perspectivas", "gestion de entendimientos", "entendimiento", "entendimientos", "perspectiva", "desacuerdo",
    ...
    [
        ["pensamiento critico", "discernimiento", "evaluacion", "discernir", "evaluar", "juzgar", "juicio",
    ...
    [
        ["orientacion al cliente", "orientacion de resultados", "orientacion", "cocreativo", "cocreacion", "crm", "satisfaccion del cliente", "gestion de relaciones", "centrado en el usuario",
    ...
    [
        ["Espiritu empresarial", "pionero", "experimento", "riesgo", "inversion", "invertir", "start-up", "start up", "oportunidad de negocio", "oportunidades de negocio", "adopcion temprana",
    ...
    [
        ["Comportamiento etico", "etica", "profesionalidad", "integro", "integridad", "honesto", "hontestidad", "igualdad", "igualitario", "equidad", "equitativo", "justicia", "justo", "transparencia", "transparente", "imparcial", "objetivo", "imparcialidad", "objetividad", "hontestidad", "sinceridad", "sincero", "honorable", "virtuoso", "noble",
