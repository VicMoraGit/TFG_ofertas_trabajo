...
ALL_SKILLS = [
    ...
    [
        ["Responsabilidad", "Compromiso", "accountability", "accountable", "responsible", "responsibility",
            "ownership", "liable", "answerable", "charged with", "account for", "answer for", "keep commitments", "duty"],
        "",
        "",
    ...
    [
        ["Adaptabilidad", "Adaptable", "Cambios", "adaptabilidad al cambio", "aceptacion del cambio", "anticipacion al cambio", "anticipacion", "aceptacion", "camaleon", "adoptar valores de la compañia", "adoptar valores de empresa", "versatil",
            "versatilidad", "situaciones impredecibles", "zona de confort", "receptivo", "receptividad", "positividad al cambio", "integracion", "integrarse", "disruptivo", "adaptacion a la ambigüedad", "encarar problemas", "encarar ambigüedad", "adjust to changes", "adaptability", "face the unexpected", "constantly changing rules", "embrace the new", "embrace change", "anticipate change", "respond to change", "adapt to change", "respond to change", "anticipate change", "join the trend", "chameleon", "swiss knife", "navaja suiza", "fit the corporate culture", "adopt corporate values", "come out of comfort zone", "versatility", "versatile", "unpredictable situations", "deal with uncertainties", "right attitude ti change", "respond positively to change", "receptiveness", "willing to learn new methods", "ganas de aprender", "integrate", "integration", "disruptive", "openness", "adapt to ambiguity", "cope with"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Coaching", "mentor", "aprendizaje", "entrenamiento", "tutor", "educar", "preparar", "guiar", "compartir",
            "guiar a otros", "compartir conocimiento", "instruir", "instructor", "mentoring", "consejero", "consejo", "teach", "train", "educate", "hone", "prepare", "guide", "share", "knowledge sharing", "guide others", "instruct", "advise", "advice", "support", "counsel", "counsellor"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Comunicación", "escuchar", "escucha activa", "comprension", "compenetración", "entendimiento", "hablar en publico", "audiencia", "presentacion", "cuestionar",
            "cuestionarse", "expresion", "expresividad", "lenguaje corporal", "observar", "observacion", "confianza", "seguro", "seguridad", "don de gentes", "interpersonal", "verbal", "listen", "listening", "active listening", "comprehension", "rapport", "presentation", "public speaking", "audience", "questioning", "non-verbal", "gesture", "expression", "body language", "observer", "observation", "confident", "written", "writing", "ability to relate to others", "disseminate", "interpersonal", "speech clarity"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Resolución de conflictos", "final pacifico de conflictos", "conflicto", "conflictos", "mediacion", "mediar", "arbitrar", "arbitraje", "diplomacia", "diplomatico", "disputa", "disputas", "disputar", "gestion de conflictos", "gestion de perspectivas", "perspectivas", "gestion de entendimientos", "entendimiento", "entendimientos", "perspectiva", "desacuerdo",
            "critica constructiva", "resolver", "resolucion", "conflict management", "peaceful ending of conflict", "collective negotiation", "manage beliefs", "mediation", "arbitration", "diplomacy", "creative peacebuilding", "dispute resolution", "manage perspectives", "manage understandings", "manage attitudes", "disagreement", "conflicts", "disputes"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Creatividad", "curiosidad", "creativo", "curioso", "inteligente", "imaginacion", "ingenuidad", "inspiracion", "original", "originalidad",
            "out of the box", "outside the box", "fuera de la caja", "beyond the box", "improvisar", "improvisacion", "innovar", "innovacion", "creativity", "curiosity", "curious", "clever", "cleverness", "genius", "imagination", "ingenuity", "inspiration", "originality", "resourcefulness", "improvise", "improvisation", "innovation", "innovate"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Pensamiento crítico", "discernimiento", "evaluacion", "discernir", "evaluar", "juzgar", "juicio",
            "pensamiento racional", "pensamiento logico", "objetividad", "considerado", "deductor", "deducción", "discernment", "evaluation", "judgement", "savvy", "appraisal", "analyse", "evaluate", "analytical", "judge", "think clearly", "think rationally", "logical reasoning", "razonamiento", "objectively", "consider", "deduce", "infer"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Orientación al cliente", "orientacion de resultados", "orientacion", "cocreativo", "cocreacion", "crm", "satisfaccion del cliente", "gestion de relaciones", "centrado en el usuario",
            "centrado en usuario", "valorar clientes", "valoracion clientes", "priorizar clientes", "priorizacion clientes", "retencion de clientes", "experiencia de usuario", "experiencia de cliente", "customer focus", "results orientation", "results oriented", "co-creating", "co-creation", "custome orientation", "crm", "serving clients' needs", "customer satisfaction", "customer relations", "customer service", "user centered", "relationship management", "customer centered", "courteous manner", "value clients", "meet service standards", "prioritize clients", "customer retention"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Toma de decisiones", "tomar decisiones", "deliberar", "deliberacion", "balancear", "determinar", "determinacion", "tomar riesgos", "correr riesgos", "interpretacion de la informacion", "interpretar informacion", "razonamiento",
            "hacer decisiones", "decidir", "decision", "decisions", "deliberating", "balancing", "assesing", "weighing up", "determining", "concluding", "take risks", "inductive", "information interpretation", "reasoning", "deductive", "choices", "decide"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Diligencia", "vigilancia", "seriedad", "intensidad", "asiduidad", "asiduo", "serio", "atento", "trabajador", "atencion al detalle", "diligence", "alertness", "earnestness", "intensity", "assiduity",
            "assiduosness", "attention to detail", "attentiveness", "briskness", "care", "carefulness", "exertion", "heed", "intent", "keenness", "hardworking", "hard-working", "conscientiousness", "detail-oriented"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Eficacia", "eficaz", "eficiente", "eficiencia", "capaz", "productivo", "productividad", "habilidoso", "optizacion", "practico", "pragmatico", "efficiency", "capability", "competente", "competence",
            "performance", "productivity", "readiness", "know-how", "proficiency", "prowess", "quantity", "practical", "pragamatic", "optimisation", "optimise", "skillfulness", "resourcefulness"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Espíritu empresarial", "pionero", "experimento", "riesgo", "inversion", "invertir", "start-up", "start up", "oportunidad de negocio", "oportunidades de negocio", "adopcion temprana",
            "influencer", "disruptive", "disruptivo", "early adopter", "crowd source", "invest", "risk", "experiment", "pioneer", "capitalism", "enterprise", "entrepreneurship"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Comportamiento ético", "etica", "profesionalidad", "integro", "integridad", "honesto", "hontestidad", "igualdad", "igualitario", "equidad", "equitativo", "justicia", "justo", "transparencia", "transparente", "imparcial", "objetivo", "imparcialidad", "objetividad", "hontestidad", "sinceridad", "sincero", "honorable", "virtuoso", "noble",
            "nobleza", "honor", "ethical behaviour", "ethic", "professionalism", "fair", "integrity", "honesty", "equality", "equity", "justice", "social justice", "transparency", "impartial", "honest", "honourable", "humane", "principled", "proper", "virtuous", "true blue", "right minded", "true-blue", "right-minded", "upright", "upstanding"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Orientación por objetivos", "goal orientation", "results orientation", "results oriented",
            "concentracion", "concentrate", "concentrado", "ambicion", "ambition", "success", "prioritario"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Iniciativa", "iniciative", "ambicion", "ambition", "proactivo", "proactive", "estratega",
            "strategy", "buscar retos", "seek challenges", "buscar oportunidades", "seek opportunities"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Liderazgo", "leadership", "role model", "modelo a seguir", "autoliderazgo", "self-leadership", "administration", "authority", "autoridad", "control", "controlar", "supervisar",
            "lead", "command", "dirigir", "influence", "influenciar", "inspirar", "inspire", "delegate", "delegar", "gestion de personas", "gestino de equipos", "people management"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Gestionar la calidad", "manage quality", "performance management", "gestion de rendimiento", "gestion de calidad", "control de calidad", "quality management",
            "capturar", "capturing", "processing", "procesar", "reunir", "gather", "investigacion", "investigar", "collect", "research", "improvement", "mejorar", ""],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Motivar a los demás", "motivate others", "encourage", "encouraging", "alentar", "animar", "instigar",
            "instigate", "conducir", "drive", "persuadir", "persuade", "inducir", "induce", "inspirar", "inspire", ""],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Motivación", "motivation", "self-motivated", "automotivacion", "automotivado", "catalyst",
            "impetu", "impetus", "incentive", "incentivar", "incentivate", "incentivo", "interes", "interest"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Relaciones sociales", "don de gentes", "network", "networking", "connections", "connect", "conexiones", "construir relaciones",
            "mantener contacto", "build relationships", "stay in touch", "lobby", "socializar", "socialise", "hacer contactos", "sociability", "sociabilizar"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Organización", "organisation", "planning", "organizar", "organise", "planfulness", "gestion del tiempo", "gestion de tiempo", "time management", "structure", "estructurar", "project management", "gestion de proyectos", "gestion de proyecto",
            "gestion de equipos", "gestion de equipo", "multi-tasking", "multitasking", "multitarea", "punto de referencia", "point of reference", "coordinar", "coordination", "coordinate", "coordinacion", "management", "methodology", "metodologia", ""],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Paciencia", "patience", "composure", "composture", "endurance", "fortituted", "humildad", "humility", "moderacion", "moderation", "serenity", "serenidad",
            "sereno", "empatico", "empatia", "empathy", "toleration", "tolerar", "tolerancia", "tolerante", "perspectiva", "perspective", "calm", "calma"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Desarrollo personal", "personal development", "professional development", "learning", "aprendizaje",
            "ambitious", "ambicioso", "ambicion", "ambition", "carrera", "career", "mejorar", "improve", "improvement"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Actitud positiva", "entusiasmo", "demostrar entusiasmo", "enthusiasm", "demonstrate enthusiasm", "posive attitude", "positive language", "lenguaje positivo", "devotion", "devocion", "eagerness",
            "seriedad", "emocion", "emotion", "energy", "energia", "interes", "passion", "interest", "pasion", "joy", "conviccion", "conviction", "vivaz", "vivacity", "optimismo", "optimism", "humour", "humor"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Resolucion de problemas", "problem-solving", "analysis", "analisis", "diagnostic", "diagnosticar", "interpretive", "interpretar", "racional", "rational", "systematic", "sistematico",
            "resolucion de conflictos", "searching", "busqueda", "testing", "testear", "test", "razonamiento", "reasoning", "synthesis", "sintesis", "perceptivo", "perceptiveness", "deductive"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Confiabilidad", "reliability", "confiable", "reliable", "dependability", "dependiente", "leal", "loyalty", "lealtad",
            "loyal", "honesto", "honest", "trustworthy", "safety", "seguridad", "accuracy", "precision", "fidelity", "fidelidad", "fiel"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Resiliencia", "resilience", "stay calm", "estar calmado", "recover", "recuperacion", "afrontar", "estres", "stress", "cope", "estoico", "estoicismo", "stoic", "stoicism",
            "tolerancia al estres", "tolerance to stress", "need for achievement", "necesidad por lograr", "logro", "identificacion de oportunidades", "opportunity identification"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Respeto a la intimidad", "privacy", "privacidad", "discreto", "discrete", "proteccion de datos", "data protection",
            "procesamiento de informacion", "information processing", "asuntos legales", "legal duty", "seguridad", "security"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Respeto a la diversidad", "respect for diversity", "inclusion", "derechos humanos", "human rights", "gender equality", "igualdad de generos", "respeto por las personas",
            "respect for people", "apreciacion", "appreciation", "dignity", "dignidad", "honor", "honour", "tolerancia", "tolerance", "adaptabilidad cultural", "cultural adaptability"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Respeto al medio ambiente", "ahorro de energia", "ahorro energetico", "energy saving", "medio ambiente", "medioambiente",
            "mediambiente", "respect the environment", "environmental sustainability", "sostenibilidad", "sostenible", "respeto por la naturaleza"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Autocontrol", "self-control", "mantener la calma", "keeping calm", "autodisciplina", "disciplinado", "self-discipline", "discipline", "seguir las reglas", "follow the rules", "dignidad", "dignity",
            "educacion", "educado", "polite", "gestion emocional", "gestion de emociones", "manage emotions", "competencia emocional", "emotional competence", "estabilidad emocional", "emotional stability"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Autogestión", "self-management", "autonomo", "autonomy", "autonomia", "autonomous", "confindent", "confiado", "confiable", "confianza", "confidence", "independiente", "independent", "independencia", "independency",
            "autosuficiente", "self-sufficient", "self-assured", "empoderado", "empoderamiento", "empowered", "mature", "maturity", "madurez", "introspeccion", "introspectivo", "introspection", "autocritica", "autocritico", "self-criticism"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Pensamiento estratégico", "strategic thinking", "importancia",
            "important", "imperativo", "imperative", "visionary", "visionario", ""],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Trabajo en equipo", "teamwork", "team", "groupwork", "trabajo en grupo", "colaborar", "colaboracion", "collaborate", "collaborative", "cooperate", "cooperar", "cooperation", "cooperacion", "harmonia", "harmony", "partnership",
            "compañerismo", "unidad", "sinergia", "synergy", "unity", "alliance", "alianza", "coalition", "coalicion", "esfuerzo combinado", "combined effort", "equipo", "team", "contribuir", "contribucion", "contribution", "contribute"],
        "",
        "",
        Categoria.SOFT_SKILL,
        SubNoAplica.NO_APLICA,
    ...
    [
        ["Tenacidad", "tenaz", "tenacity", "perseverance", "perseverancia", "persevere", "perseverar", "persitencia", "persitente", "persistence", "persistir", "persist", "commitment", "comprometer",
            "compromiso", "committed", "comprometido", "coraje", "courage", "asertivo", "assertiveness", "asertividad", "assertive", "firmnsess", "firmeza", "determinacion", "determination"],
